      ...
      >
        ...
        >
          ...
          >
            ...
            {/*logo goes up */}
            <Box sx={{ display: "flex", width:{xs:'35vw',sm:'auto'}, flex: { xs: 6, sm: 3 },marginRight:{xs:"0px",sm:'15px'} }}>
              <TextField
              sx={{width:{xs:'35vw',sm:'auto'}, position:{xs:'absolute', sm:"relative"}, right:{xs:'90px',sm:'0'}}}
                onChange={(e) => {
